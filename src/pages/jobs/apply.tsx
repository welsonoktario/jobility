        ...
        >
          ...
          <Flex direction="column" gap={18}>
            ...
            >
              ...
              <Flex direction="column" gap={18}>
                ...
                >
                  ...
                  <RadioGroup value={personalInfo.gender} onChange={(newValue: Gender) => {
                      ...
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          ...
                          if (validateInputString('skills', skillsInputValue).status) {
                            setPersonalInfo({...personalInfo, skills: [...personalInfo.skills, skillsInputValue]});
                          }
                        }
                      }}
                      onChange={(e) => {
            ...
            <Flex
              ...
              boxShadow="md"
            >
              <FormControl isInvalid={!validateInputString('resume', personalInfo.linkResume).status} isRequired>
                <FormLabel fontSize="md" fontWeight="bold" mb={18}>
                  Resume
                </FormLabel>
                <Text mb={2}>
                  Please put your link to the drive where your resume in.
                </Text>
                <Input type="text" defaultValue={personalInfo.linkResume} placeholder='Link to resume' onBlur={(e) => setPersonalInfo({...personalInfo, linkResume: e.target.value})}></Input>
                {!validateInputString('resume', personalInfo.linkResume).status && <FormErrorMessage>{validateInputString('resume', personalInfo.linkResume).errors[0]}</FormErrorMessage>}
              </FormControl>
            </Flex>
          </Flex>
          {/* Second Column */}
